    ...
    <div id="confirmModal" style="
        ...
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:8px">
            <div style="width:42px;height:42px;border-radius:50%;flex-shrink:0;
                ...
                <i class="fas fa-car" style="color:var(--ferrari-red);font-size:16px"></i>
            </div>
            <div>
                <div style="font-family:'Bebas Neue',sans-serif;font-size:18px;letter-spacing:2px">Add New Car</div>
        ...
        <p style="color:#aaa;font-size:12px;line-height:1.6;margin:12px 0 16px">
            You are about to add a new car to the shop.<br>
        ...
        <div style="display:flex;gap:10px">
            <button id="confirmOkBtn" onclick="submitConfirm()" style="
                ...
                onmouseover="this.style.background='#b00000';this.style.transform='translateY(-1px)'"
                onmouseout="this.style.background='var(--ferrari-red)';this.style.transform=''">
                <i id="confirmOkIcon" class="fas fa-car"></i>
                <span id="confirmOkText">Add Car</span>
...
function formHasData() {
    const fields = document.querySelectorAll('#addCarForm input:not([type=hidden]):not([type=radio]):not([type=checkbox]), #addCarForm textarea');
